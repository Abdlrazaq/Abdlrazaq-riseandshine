...
import { CoursesTrainingComponent } from './courses-training/courses-training.component';
import { SeatingsChakraComponent } from './seatings-chakra/seatings-chakra.component';
...
const routes: Routes = [
  ...
  {path:'courses-training',component:CoursesTrainingComponent},  
  {path:'seatings-chakra',component:SeatingsChakraComponent},
